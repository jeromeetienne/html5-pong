...
var Game	= function Game(ctor_opts){
	...
	var stateCtor	= function(){
		...
		curState.register(GameState.WAIT_PLAY, stWaitPlayEnter, stWaitPlayLeave);
	}
	var stateDtor	= function(){
		clearTimeout(stateTimer);
		stateTimer	= null;
	}
	var stateGoto	= function(newState, args){
		playersSend({
	...
	var stPresPageEnter	= function(){
		stateTimer	= setTimeout(function(){
			stateGoto(GameState.WAIT_PLAY);
		}, 5*1000);
	}
	...
	var stWaitPlayEnter	= function(){
	}
	var stWaitPlayLeave	= function(){
	}
