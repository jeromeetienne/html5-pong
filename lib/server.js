...
var Ball	= function(ctor_opts){
	...
	var vector	= ctor_opts.vector	|| { angle: Math.PI+Math.PI/3, speed: 0.03};
...
var Player	= function Player(ctor_opts){
	...
	*/
	...
	var collideBall	= function(ball_old_pos, ball_new_pos){
		var limitLeft	= 0;
		var limitRight	= 1;
		var racketH	= 75*1/150;
		var limitRacketL= limitLeft  + (12.5*1/300);	// TODO those constant depends
		var limitRacketR= limitRight - (12.5*1/300);
